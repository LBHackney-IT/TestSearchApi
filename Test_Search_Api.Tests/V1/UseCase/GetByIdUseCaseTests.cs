...
using Test_Search_Api.V1.UseCase;
using Hackney.Core.Testing.Shared;
using Moq;
using NUnit.Framework;

namespace Test_Search_Api.Tests.V1.UseCase
{
    public class GetByIdUseCaseTests : LogCallAspectFixture
    {
        ...
        //Guidance on unit testing and example of mocking can be found here https://github.com/LBHackney-IT/lbh-test-search-api/wiki/Writing-Unit-Tests
    }
}
