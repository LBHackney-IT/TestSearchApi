using AutoFixture;
using Test_Search_Api.Tests.V1.Helper;
using Test_Search_Api.V1.Domain;
using Test_Search_Api.V1.Gateways;
using FluentAssertions;
using NUnit.Framework;

namespace Test_Search_Api.Tests.V1.Gateways
{
    //TODO: Remove this file if Postgres gateway is not being used
    //TODO: Rename Tests to match gateway name
    //For instruction on how to run tests please see the wiki: https://github.com/LBHackney-IT/lbh-test-search-api/wiki/Running-the-test-suite.
    [TestFixture]
